...
\note{todo: think about the difference between per-dataset AP and average per-image AP. see relevant section in~\cite{Desai2009}: the latter is higher and makes more sense for us.}
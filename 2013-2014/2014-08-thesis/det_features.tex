...
An \emph{open-loop} policy, such as the common classifier cascade \parencite{Viola2004}, takes actions in a sequence that does not depend on observations received from previous actions.

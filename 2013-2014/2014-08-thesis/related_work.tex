...
\PM{CNNs}
Most recently, best performance is obtained not with hand-designed features but with those learned on large-scale labeled datasets by a deep convolutional architecture \parencite{Krizhevsky-NIPS-2012,Girshick-CVPR-2014}.
The method of \cite{Girshick-CVPR-2014} in particular is powerful but slow, requiring costly processing of many windows.

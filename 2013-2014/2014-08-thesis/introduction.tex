...
\PM{Detection}
State-of-the-art object detectors are slow, and need to process many regions of each image \parencite{Felzenszwalb2010a,Girshick-CVPR-2014}.
...
\todo{Paragraph motivating Cascaded-CNN.}
...
\todo{On the same dataset, our Cascaded CNN method obtains nearly state-of-the-art performance with a 16x speed-up}.
